...
export function Logo({
  ...
  const sizeMap = {
    ...
    md: { icon: 'w-8 h-8 sm:w-9 sm:h-9', text: 'text-base sm:text-lg', gap: 'gap-2.5' },
    lg: { icon: 'w-10 h-10 sm:w-11 sm:h-11', text: 'text-xl sm:text-2xl', gap: 'gap-3' },
    xl: { icon: 'w-12 h-12 sm:w-14 sm:h-14', text: 'text-2xl sm:text-3xl', gap: 'gap-3.5' },
  };
